...
def test_get_authorized_and_user_id_missing_value_error(
    app, supported_action, supported_protocol, indexd_client_accepting_record
):
    """
    Test fence.blueprints.data.indexd.IndexedFile get_authorized_and_user_id without authz in indexd record
    """
    ...
    with patch("fence.blueprints.data.indexd.flask.current_app", return_value=app):
        ...
        with pytest.raises(ValueError):
            indexed_file.get_authorized_and_user_id(supported_action)
