...
@pytest.mark.parametrize(
    'unauthorized_indexd_client', ['gs', 's3'], indirect=True)
...
@pytest.mark.parametrize('public_indexd_client', ['gs', 's3'], indirect=True)
...
@pytest.mark.parametrize(
    'public_bucket_indexd_client', ['gs', 's3'], indirect=True)
