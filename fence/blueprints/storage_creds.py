...
def list_keypairs(provider):
    ...
    **Example:**
    ...
    if provider == 'cdis':
        ...
        result = flask.current_app.storage_manager.list_keypairs(
    ...
    **Example:**
    ...
    if provider == 'cdis':
        ...
        result = create_refresh_token(
            flask.g.user, flask.current_app.keypairs[0],
            flask.request.args.get('expire', 2592000),
            scopes, client_id
        )
        return flask.jsonify(dict(token=result))
    elif provider == 'google':
        ...
        return
    flask.jsonify(flask.current_app.storage_manager.create_keypair(provider, flask.g.user))
    ...
    **Example:**
    ...
    if provider == 'cdis':
        ...
        result = create_access_token(
            flask.g.user, flask.current_app.keypairs[0],
            flask.request.form['refresh_token'],
            flask.request.args.get('expire', 2592000),
            scopes, client_id
        )
